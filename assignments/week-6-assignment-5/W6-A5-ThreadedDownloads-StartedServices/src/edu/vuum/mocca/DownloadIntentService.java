...
public class DownloadIntentService extends IntentService {
    ...
    public static Intent makeIntent(Context context,
    	...
    	Log.i("DownloadIntentService", "In makeIntent");
    	
    	/// WRONG!  
        /// return DownloadUtils.makeMessengerIntent(context, DownloadActivity.class,
        ///        handler, uri);
	...
	protected void onHandleIntent (Intent intent) {
        ...
        /// Note: Craig used this rather than getApplicationContext()
