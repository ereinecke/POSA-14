...
public class DownloadActivity extends DownloadBase {
		...
		public void handleMessage(Message msg) {
            ...
            if (activity != null) {
                ...
                if (msg.arg1 != RESULT_OK || pathname == null)
                    Log.i(DownloadUtils.TAG,"failed download");
    ...
    public void runService(View view) {
    	String which = "";
    	String url = Uri.parse(getUrlString()).toString();
        ...
        case R.id.intent_service_button:
        	...
        	/// 
        	/// Note: Craig did this without separate declarations
        	/// for url, and intent, as follows: 
	        ...
	        // Start the DownloadIntentService.
	        startService(intent);
